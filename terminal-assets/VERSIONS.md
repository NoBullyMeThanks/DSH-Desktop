# terminal-assets 版本锁定

本目录是终端面板页面（terminal.html）使用的 xterm.js 静态资源，直接从 npm 包拷贝，
...
Copy-Item "$dir\node_modules\@xterm\xterm\lib\xterm.js"  terminal-assets\xterm.js
Copy-Item "$dir\node_modules\@xterm\xterm\css\xterm.css" terminal-assets\xterm.css
Copy-Item "$dir\node_modules\@xterm\addon-fit\lib\addon-fit.js" terminal-assets\addon-fit.js
Copy-Item "$dir\node_modules\@xterm\addon-clipboard\lib\addon-clipboard.js" terminal-assets\addon-clipboard.js
```
